module BoleroMAUI.Server.Index
...
let page = doctypeHtml {
    head {
        ...
        link { attr.rel "stylesheet"; attr.href "BoleroMAUI.Client.styles.css" }
    }
    body {
        nav {
        ...
        div {
            attr.id "main"
            comp<Shared.MyApp> { attr.renderMode RenderMode.InteractiveWebAssembly }
        }
        boleroScript
    }
}
